---
mode: agent
description: "Interactive PRD generator - problem-first, hypothesis-driven product spec using PRP methodology"
tools: ["filesystem", "changes", "githubRepo"]
---

# Product Requirements Document Generator (PRP Methodology)
...
**Explore codebase (if applicable) to find:**
...
**Explore codebase to assess feasibility:**
...
**Output path**: `PRPs/prds/{kebab-case-name}.prd.md`
...
Run: `#prp-plan PRPs/prds/{name}.prd.md`
